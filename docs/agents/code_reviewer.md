...
7. Simplicity: Flag shallow wrappers, test-only entry points, unjustified defensive casts/defaults, duplicated logic, over-broad abstractions, XML docs that restate obvious signatures, and comments that describe obvious code.
