...
- `summary-2026-09-08-framework-testability.md` - Added explicit named DB factories, scoped configuration, strict fakes, disposable SQLite behavior tests, and FW database ownership.
