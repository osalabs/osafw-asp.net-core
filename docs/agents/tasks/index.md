...
- `summary-2026-09-08-pdf-local-assets.md` - Opt-in PDF local assets with bounded ConvUtils helpers, preserved output on failure, and best-effort download cleanup plus stale-file retries.
