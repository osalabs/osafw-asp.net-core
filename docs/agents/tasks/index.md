...
- `summary-2026-09-05-spages-cms.md` - Implemented the block CMS and standard dynamic admin, consolidated status, separated starter seeds, preserved tree APIs, refined hierarchy/columns/editor/image usability, and verified publication/provider/access behavior with recorded limits.
