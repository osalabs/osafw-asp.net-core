...
- `summary-2026-09-08-pdf-local-assets.md` - Opt-in local PDF assets with offline rendering, constrained static files and local-mode output cleanup; legacy in-place writes preserved.
