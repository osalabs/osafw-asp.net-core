...
- `summary-2026-08-30-adaptive-workflow-benchmark-promotion.md` - Promoted benchmark-backed direct-first routing, a one-stage orchestration budget, bounded Terra Medium implementation, conditional Max implementation/review, public-entry controls, portable copied-pack validation, and mandatory supplemental summary audit in instruction pack 1.3.0.
