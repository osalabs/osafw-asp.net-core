...
- `summary-2026-09-08-typed-row-regeneration.md` - Added explicit preview/apply typed Row regeneration for selected model sources with Roslyn parsing, stale-preview rejection, and Developer Tools write guards; verified after master and schema-tooling synchronization.
