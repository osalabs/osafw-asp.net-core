...
- `summary-2026-09-05-spages-cms.md` - Implemented the block CMS and standard dynamic admin, consolidated status, separated starter seeds, preserved tree APIs, refined hierarchy/columns/editor/image usability, header publishing, record navigation/ancestry, page/snippet settings forms, consistent badges, public/preview links, page-associated snippet creation, consolidated public/preview breadcrumbs, and editor View page, and verified publication/provider/access behavior with recorded limits.
