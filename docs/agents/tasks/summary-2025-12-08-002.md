...
Latest build with `/root/dotnet/dotnet build /p:LibraryRestore=false /clp:Summary` reports 177 nullable warnings, concentrated in FW, FwLogger, EntityBuilder, and Utils.
