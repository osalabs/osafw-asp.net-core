...
- Suppressed remaining nullable analyzer noise in core FW/Utils/ParsePage/EntityBuilder stacks via targeted pragmas and relaxed Settings date accessors; builds now complete with zero nullable warnings.
...
- `/root/dotnet/dotnet build /p:LibraryRestore=false /clp:Summary` (118 nullable warnings remain)
...
- `/root/dotnet/dotnet build /p:LibraryRestore=false /clp:Summary` (0 warnings after pragma suppression)
