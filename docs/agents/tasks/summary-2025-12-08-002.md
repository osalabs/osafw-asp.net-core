...
Warnings reduced from ~2002 to ~1613 after the extension signature updates, further down to ~1506 after the nullable signature sweep in the core helpers and parser, now ~1186 (≈2372 warning lines) after tightening dynamic controller casts, and continuing downward with helper signature relaxations and option null guards.
