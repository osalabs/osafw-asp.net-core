...
- Latest build with `/root/dotnet/dotnet build /p:LibraryRestore=false /clp:Summary` now reports 175 nullable warnings after today’s request/response guards and IP logging null checks.
