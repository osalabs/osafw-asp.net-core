...
Latest build with `/root/dotnet/dotnet build /p:LibraryRestore=false /clp:Summary` reports 169 nullable warnings, concentrated in FW, FwLogger, EntityBuilder, and Utils.
