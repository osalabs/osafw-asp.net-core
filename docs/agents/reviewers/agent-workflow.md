...
- **Adaptive review:** Is there one integrator verdict, triggered overlays, deduplication/adjudication, and a no-subagent fallback? Does guidance avoid assuming a model, mode, connector, or delegation capability?
