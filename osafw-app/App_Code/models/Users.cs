...
public class Users : FwModel<Users.Row>
{
    ...
    /// <param name="trim_at">Maximum password length accepted for legacy hash compatibility.</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// reset session and fill with user info from id, log login activity, update login time and apply browser timezone for auto users if provided
    /// </summary>
    /// <param name="id"></param>
