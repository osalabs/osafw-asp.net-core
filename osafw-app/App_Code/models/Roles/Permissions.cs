...
public class Permissions : FwModel
{
    ...
    protected Hashtable MAP_ACTIONS_PERMISSIONS = new Hashtable
    {
        { FW.ACTION_INDEX, PERMISSION_LIST },
        { FW.ACTION_SHOW, PERMISSION_VIEW },
        //{ FW.ACTION_SHOW_FORM, PERMISSION_ADD }, //TODO distinguish between add and edit
        ...
        //{ FW.ACTION_DELETE, PERMISSION_DELETE_PERMANENT } //TODO distinguish between add and edit
        { FW.ACTION_DELETE_RESTORE, PERMISSION_DELETE_PERMANENT}, //if can delete permanently - can restore too
    ...
    public string mapActionToPermission(string action)
    {
