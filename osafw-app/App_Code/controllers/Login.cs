...
#pragma warning restore SCS0005 // Weak random generator
            ...
            if (!is_dev_login)
            {
                ...
                {
                    fw.logAction(FwLogTypes.ICODE_USERS_LOGIN_FAIL, FwEntities.ICODE_USERS, 0, login);
    ...
    {
        fw.logAction(FwLogTypes.ICODE_USERS_LOGOFF, FwEntities.ICODE_USERS, fw.userId);
    ...
    public void SaveMFAAction()
    {
        ...
        if (!model.isValidMFA(users_id, mfs_code))
        {
            ...
            if (!model.checkMFARecovery(users_id, mfs_code))
            {
                ...
                fw.logAction(FwLogTypes.ICODE_USERS_LOGIN_FAIL, FwEntities.ICODE_USERS, users_id, "mfa fail");
                fw.redirect(base_url + "/(MFA)");
            }
        }
