...
CREATE TABLE users (
  ...
  date_format           NVARCHAR(8) NOT NULL DEFAULT 'MDY', -- user's date format
  time_format           NVARCHAR(8) NOT NULL DEFAULT '24', -- user's time format 12/24
  timezone              NVARCHAR(64) NOT NULL DEFAULT 'UTC', -- user's timezone id
