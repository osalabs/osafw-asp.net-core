...
'upload utils
public virtual Function uploadFile(id As Integer, ByRef filepath As String, Optional input_name As String = "file1", Optional is_skip_check As Boolean = False) As Boolean
...
' id splitted to 1000
public virtual Function getUploadDir(ByVal id As Long) As String
Return UploadUtils.getUploadDir(fw, table_name, id)
}

public virtual Function getUploadUrl(ByVal id As Long, ByVal ext As String, Optional size As String = "") As String
Return UploadUtils.getUploadUrl(fw, table_name, id, ext, size)
}

'removes all type of image files uploaded with thumbnails
public virtual Function removeUpload(ByVal id As Long, ByVal ext As String) As Boolean
...
public virtual Function getUploadImgPath(ByVal id As Long, ByVal size As String, Optional ext As String = "") As String
...
public virtual Function getSelectOptions(sel_id As String) As String
Return FormUtils.selectOptions(Me.listSelectOptions(), sel_id)
}

public virtual Function getAutocompleteList(q As String) As ArrayList
Dim where As New Hashtable
...
public virtual Function getMultiListAL(ids As ArrayList, Optional params As Object = Nothing) As ArrayList
...
'params - to use - override in your model
public virtual Function getMultiList(sel_ids As String, Optional params As Object = Nothing) As ArrayList
...
''' <returns></returns>
public virtual Function getLinkedIds(link_table_name As String, id As Integer, id_name As String, link_id_name As String) As ArrayList
Dim where As New Hashtable
where(id_name) = id
...
public virtual Sub updateLinked(link_table_name As String, id As Integer, id_name As String, link_id_name As String, linked_keys As Hashtable)
...
public virtual Function findOrAddByIname(iname As String, ByRef Optional is_added As Boolean = False) As Integer
iname = Trim(iname)
...
public virtual Function getCSVExport() As StringBuilder
Dim where As New Hashtable
